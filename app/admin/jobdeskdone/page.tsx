...
const JobdeskSelesai = () => {
  ...
  const fetchDataJobdesk = async () => {
    try {
      const response = await fetch(`/admin/api/jobdeskdone`);
        ...
        <div className="col-md-12 grid-margin stretch-card">
          <div className="card">
            <div className="card-header">
              <h1 className="card-title" style={{ fontFamily: "initial", fontSize: 25 }}>Data Semua Tugas</h1>
            </div>
